...
import com.qualcomm.widget.UVCCameraTextureView;
...
public abstract class GraphicalActivity extends Activity
{
    ...
    /** Main layout */
    protected int                         mMainLayout = R.layout.activity_main;
    ...
    private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(final View view) {
            if (mUVCCamera == null)
                CameraDialog.showDialog(GraphicalActivity.this);                //CameraDialog.showDialog(MainActivity.this);
            else {
                mUVCCamera.destroy();
                mUVCCamera = null;
            }
    ...
    private final OnDeviceConnectListener mOnDeviceConnectListener = new OnDeviceConnectListener() {
        ...
        public void onAttach(final UsbDevice device) {
            Toast.makeText(GraphicalActivity.this, "USB_DEVICE_ATTACHED", Toast.LENGTH_SHORT).show();
        }
                    ...
                    mUVCCamera.setStatusCallback(new IStatusCallback() {
                        ...
                        public void onStatus(final int statusClass, final int event, final int selector,
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(GraphicalActivity.this, "onStatus(statusClass=" + statusClass
                                            + "; " +
                                            "event=" + event + "; " +
                                            "selector=" + selector + "; " +
                    ...
                    mUVCCamera.setButtonCallback(new IButtonCallback() {
                        ...
                        public void onButton(final int button, final int state) {
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(GraphicalActivity.this, "onButton(button=" + button + "; " +
...
//						mUVCCamera.setFrameCallback(mIFrameCallback, UVCCamera.PIXEL_FORMAT_RGB565/*UVCCamera.PIXEL_FORMAT_NV21*/);
        ...
        public void onDettach(final UsbDevice device) {
            Toast.makeText(GraphicalActivity.this, "USB_DEVICE_DETACHED", Toast.LENGTH_SHORT).show();
        }
     ...
     */
    @Override
    protected void onResume()   // method is public in usbCameraTest
    {
        super.onResume();
